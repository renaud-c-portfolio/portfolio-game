const projects = [
    {
        ...
        details: ["This game is being made with two goals in mind: <ul><li>Provide an alternative to competitive battles of another popular monster game, but without the random elements</li><li>Make this type of game purely as a HTML/Javascript website, instead of using GameMaker</li></ul>"
            ,"This game's creatures are also procedurally generated by users mixing Elements with Animal Shapes, leading to a near infinity of results."],
        detailsSrc: ["game/creature-png.png","game/creature-png.png"],
    ...
    },  
    {
        ...
        detailsSrc: ["game/cosmic-png.png","game/cosmic-png.png"],
    ...
    }, 
    {
        ...
        details: ["Energetic platform-battler for 2 to 4 players. Choosing your different character will lead to a different power.<br/> Your characters have regenerating health but there is no HUD, obvious heart particle effects instead indicate your health loss and gain. Different attacks will cause half or full heart's worth of damage.<br/><br/>A special powerup is available for those who can stand in the volcano's flame... Is it worth the danger?",
        ...
        detailsSrc: [ "game/rainbow-png.png", "game/rainbow-png.png"],
